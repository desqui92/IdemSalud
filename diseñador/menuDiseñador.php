<div class="col-xl-4 wow fadeInLeft" id="menu-administracion">
                ...
                <ul class="nav flex-column text-center">
                    <li class="nav-item">
                        <a class="nav-link" href="agregarpublicacion.php"><i class="fas fa-user fa-lg"></i> Subir publicación</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../blog.php"><i class="fab fa-blogger-b fa-lg"></i> Ver Blog</a>
                    </li>
                    <li class="nav-item">
